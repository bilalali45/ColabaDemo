...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class InformationMediumMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<InformationMedium>
    {
        public void Configure(EntityTypeBuilder<InformationMedium> builder)
        {
            builder.ToTable("InformationMedium", "dbo");
