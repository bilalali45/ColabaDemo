...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LoanDocumentSubTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LoanDocumentSubType>
    {
        public void Configure(EntityTypeBuilder<LoanDocumentSubType> builder)
        {
            builder.ToTable("LoanDocumentSubType", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.LoanDocumentType).WithMany(b => b.LoanDocumentSubTypes).HasForeignKey(c => c.LoanDocumentTypeId).OnDelete(DeleteBehavior.SetNull); // FK_LoanDocumentSubType_LoanDocumentType
            InitializePartial();
        }
