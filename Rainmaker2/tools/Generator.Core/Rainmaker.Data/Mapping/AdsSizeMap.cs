...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class AdsSizeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<AdsSize>
    {
        public void Configure(EntityTypeBuilder<AdsSize> builder)
        {
            builder.ToTable("AdsSize", "dbo");
