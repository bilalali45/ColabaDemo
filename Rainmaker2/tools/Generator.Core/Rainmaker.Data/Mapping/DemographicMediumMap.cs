...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class DemographicMediumMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<DemographicMedium>
    {
        public void Configure(EntityTypeBuilder<DemographicMedium> builder)
        {
            builder.ToTable("DemographicMedium", "dbo");
