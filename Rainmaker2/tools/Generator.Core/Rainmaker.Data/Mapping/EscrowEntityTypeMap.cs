...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class EscrowEntityTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<EscrowEntityType>
    {
        public void Configure(EntityTypeBuilder<EscrowEntityType> builder)
        {
            builder.ToTable("EscrowEntityType", "dbo");
            ...
            builder.Property(x => x.EscrowGroupId).HasColumnName(@"EscrowGroupId").HasColumnType("int").IsRequired(false);
            InitializePartial();
        }
