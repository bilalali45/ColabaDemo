...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class PropertyUsageMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<PropertyUsage>
    {
        public void Configure(EntityTypeBuilder<PropertyUsage> builder)
        {
            builder.ToTable("PropertyUsage", "dbo");
