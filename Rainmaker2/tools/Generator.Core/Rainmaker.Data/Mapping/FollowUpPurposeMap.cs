...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class FollowUpPurposeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<FollowUpPurpose>
    {
        public void Configure(EntityTypeBuilder<FollowUpPurpose> builder)
        {
            builder.ToTable("FollowUpPurpose", "dbo");
