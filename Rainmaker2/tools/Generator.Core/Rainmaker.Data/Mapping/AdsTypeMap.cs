...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class AdsTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<AdsType>
    {
        public void Configure(EntityTypeBuilder<AdsType> builder)
        {
            builder.ToTable("AdsType", "dbo");
