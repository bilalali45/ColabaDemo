...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class CreditScoreMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<CreditScore>
    {
        public void Configure(EntityTypeBuilder<CreditScore> builder)
        {
            builder.ToTable("CreditScore", "dbo");
            ...
            builder.Property(x => x.From).HasColumnName(@"From").HasColumnType("int").IsRequired(false);
            builder.Property(x => x.To).HasColumnName(@"To").HasColumnType("int").IsRequired(false);
            InitializePartial();
        }
