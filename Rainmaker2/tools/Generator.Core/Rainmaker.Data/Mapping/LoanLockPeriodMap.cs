...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LoanLockPeriodMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LoanLockPeriod>
    {
        public void Configure(EntityTypeBuilder<LoanLockPeriod> builder)
        {
            builder.ToTable("LoanLockPeriod", "dbo");
            ...
            builder.Property(x => x.IsCustomerDisplay).HasColumnName(@"IsCustomerDisplay").HasColumnType("bit").IsRequired();
