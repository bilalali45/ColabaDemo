...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LoanPurposeProgramMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LoanPurposeProgram>
    {
        public void Configure(EntityTypeBuilder<LoanPurposeProgram> builder)
        {
            builder.ToTable("LoanPurposeProgram", "dbo");
