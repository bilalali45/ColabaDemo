...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class StatusCauseMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<StatusCause>
    {
        public void Configure(EntityTypeBuilder<StatusCause> builder)
        {
            builder.ToTable("StatusCause", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.StatusList).WithMany(b => b.StatusCauses).HasForeignKey(c => c.StatusId).OnDelete(DeleteBehavior.SetNull); // FK_StatusCause_StatusList
            InitializePartial();
        }
