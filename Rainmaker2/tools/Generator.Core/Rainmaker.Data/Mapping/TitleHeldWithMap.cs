...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class TitleHeldWithMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<TitleHeldWith>
    {
        public void Configure(EntityTypeBuilder<TitleHeldWith> builder)
        {
            builder.ToTable("TitleHeldWith", "dbo");
