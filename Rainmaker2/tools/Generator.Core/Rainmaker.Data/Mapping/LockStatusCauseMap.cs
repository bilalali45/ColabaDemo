...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LockStatusCauseMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LockStatusCause>
    {
        public void Configure(EntityTypeBuilder<LockStatusCause> builder)
        {
            builder.ToTable("LockStatusCause", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.LockStatusList).WithMany(b => b.LockStatusCauses).HasForeignKey(c => c.LockStatusId).OnDelete(DeleteBehavior.SetNull); // FK_LockStatusCause_LockStatusList
            InitializePartial();
        }
