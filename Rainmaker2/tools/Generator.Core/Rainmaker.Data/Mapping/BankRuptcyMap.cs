...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class BankRuptcyMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<BankRuptcy>
    {
        public void Configure(EntityTypeBuilder<BankRuptcy> builder)
        {
            builder.ToTable("BankRuptcy", "dbo");
