...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class SupportPaymentTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<SupportPaymentType>
    {
        public void Configure(EntityTypeBuilder<SupportPaymentType> builder)
        {
            builder.ToTable("SupportPaymentType", "dbo");
