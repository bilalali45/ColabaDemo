...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class AdsPageLocationMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<AdsPageLocation>
    {
        public void Configure(EntityTypeBuilder<AdsPageLocation> builder)
        {
            builder.ToTable("AdsPageLocation", "dbo");
