...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class QuestionSectionMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<QuestionSection>
    {
        public void Configure(EntityTypeBuilder<QuestionSection> builder)
        {
            builder.ToTable("QuestionSection", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.QuestionGroup).WithMany(b => b.QuestionSections).HasForeignKey(c => c.QuestionGroupId).OnDelete(DeleteBehavior.SetNull); // FK_QuestionSection_QuestionGroup
            InitializePartial();
        }
