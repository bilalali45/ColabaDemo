...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class ThirdPartyStatusListMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<ThirdPartyStatusList>
    {
        public void Configure(EntityTypeBuilder<ThirdPartyStatusList> builder)
        {
            builder.ToTable("ThirdPartyStatusList", "dbo");
