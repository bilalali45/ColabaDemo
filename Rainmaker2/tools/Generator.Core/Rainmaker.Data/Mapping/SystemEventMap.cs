...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class SystemEventMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<SystemEvent>
    {
        public void Configure(EntityTypeBuilder<SystemEvent> builder)
        {
            builder.ToTable("SystemEvent", "dbo");
            builder.HasKey(x => x.Id);

            builder.Property(x => x.Id).HasColumnName(@"Id").HasColumnType("int").IsRequired().ValueGeneratedOnAdd();
            builder.Property(x => x.SystemKeyword).HasColumnName(@"SystemKeyword").HasColumnType("nvarchar").IsRequired().HasMaxLength(100);
