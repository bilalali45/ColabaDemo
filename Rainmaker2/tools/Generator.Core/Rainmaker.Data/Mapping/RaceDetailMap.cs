...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class RaceDetailMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<RaceDetail>
    {
        public void Configure(EntityTypeBuilder<RaceDetail> builder)
        {
            builder.ToTable("RaceDetail", "dbo");
            ...
            builder.Property(x => x.RaceId).HasColumnName(@"RaceId").HasColumnType("int").IsRequired(false);
            ...
            // Foreign keys
            builder.HasOne(a => a.Race).WithMany(b => b.RaceDetails).HasForeignKey(c => c.RaceId).OnDelete(DeleteBehavior.SetNull); // FK_RaceDetail_Race
            InitializePartial();
        }
