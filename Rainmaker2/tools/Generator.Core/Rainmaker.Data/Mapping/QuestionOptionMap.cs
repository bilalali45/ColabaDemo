...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class QuestionOptionMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<QuestionOption>
    {
        public void Configure(EntityTypeBuilder<QuestionOption> builder)
        {
            builder.ToTable("QuestionOption", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.Question).WithMany(b => b.QuestionOptions).HasForeignKey(c => c.QuestionId).OnDelete(DeleteBehavior.SetNull); // FK_QuestionOption_Question
            InitializePartial();
        }
