...
namespace RainMaker.Entity.Models
{
    ...
    public partial class County : URF.Core.EF.Trackable.Entity
    {
        ...
        /// <summary>
        /// Child PromotionalPrograms where [PromotionalProgram].[CountyId] point to this entity (FK_PromotionalPrograms_County)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<PromotionalProgram> PromotionalPrograms { get; set; } // PromotionalProgram.FK_PromotionalPrograms_County
        /// <summary>
