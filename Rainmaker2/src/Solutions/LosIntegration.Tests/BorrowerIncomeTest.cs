...
{
    public class BorrowerIncomeTest
    {
        [Fact]
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new BorrowerIncomeController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            Income income = new Income();
            //income.GetRainmakerBorrowerIncome();
            //IActionResult result = await controller.PostAsync(income);
            //Assert
