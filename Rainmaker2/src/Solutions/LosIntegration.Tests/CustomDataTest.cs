...
namespace LosIntegration.Tests
{
    public class CustomDataTest
    {
        ...
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new CustomDataController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            ByteCustomValue byteCustomValue = new ByteCustomValue();
            //byteCustomValue.GetRainmakerCustomValue();
            //IActionResult result = await controller.PostAsync(byteCustomValue);
            //Assert
