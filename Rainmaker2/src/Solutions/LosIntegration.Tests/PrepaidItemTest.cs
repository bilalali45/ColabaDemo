...
namespace LosIntegration.Tests
{
    public class PrepaidItemTest
    {
        ...
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new PrepaidItemController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            PrepaidItem prepaidItem = new PrepaidItem();
            //prepaidItem.GetRainmakerPrepaidItem();
            //IActionResult result = await controller.PostAsync(prepaidItem);
            //Assert
