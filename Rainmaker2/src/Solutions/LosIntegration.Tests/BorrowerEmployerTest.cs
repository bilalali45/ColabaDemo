...
{
    public class BorrowerEmployerTest
    {
        [Fact]
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new BorrowerEmployerController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            Employer employer = new Employer();
            //employer.GetRainmakerBorrowerEmployer();
            //IActionResult result = await controller.PostAsync(employer);
            //Assert
