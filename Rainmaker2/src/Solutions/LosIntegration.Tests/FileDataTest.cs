...
namespace LosIntegration.Tests
{
    public class FileDataTest
    {
        ...
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new FileDataController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            FileData fileData = new FileData();
            //fileData.GetRainmakerFileData();
            //IActionResult result = await controller.PostAsync(fileData);
            //Assert
