...
{
   public class BorrowerResidenceTest
    {
        [Fact]
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new BorrowerResidenceController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            Residence residence = new Residence();
            //residence.GetRainmakerBorrowerResidence();
            //IActionResult result = await controller.PostAsync(residence);
            //Assert
