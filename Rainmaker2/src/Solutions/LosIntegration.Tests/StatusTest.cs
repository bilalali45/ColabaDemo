...
namespace LosIntegration.Tests
{
    public class StatusTest
    {
        ...
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new StatusController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            Status status = new Status();
            //status.GetRainmakerStatus();
            //IActionResult result = await controller.PostAsync(status);
            //Assert
