...
{
   public class BorrowerAssetTest
    {
        [Fact]
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new BorrowerAssetController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            Asset byteAsset = new Asset();
            //byteAsset.GetRainmakerBorrowerAsset();
            //IActionResult result = await controller.PostAsync(byteAsset);
            //Assert
