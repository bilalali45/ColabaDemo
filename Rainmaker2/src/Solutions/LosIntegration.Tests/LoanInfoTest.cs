...
namespace LosIntegration.Tests
{
    public class LoanInfoTest
    {
        ...
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new LoanInfoController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            LoanInfo loanInfo = new LoanInfo();
            //loanInfo.GetRainmakerLoanInfo();
            //IActionResult result = await controller.PostAsync(loanInfo);
            //Assert
