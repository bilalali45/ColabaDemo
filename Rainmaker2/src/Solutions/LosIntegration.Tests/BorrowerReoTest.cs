...
namespace LosIntegration.Tests
{
    public class BorrowerReoTest
    {
        ...
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new BorrowerReoController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            REO reo = new REO();
            //reo.GetRainmakerBorrowerReo();
            //IActionResult result = await controller.PostAsync(reo);
            //Assert
