...
namespace LosIntegration.Tests
{
    public class BorrowerTest
    {
        ...
        public async Task TestPostAsyncController()
        {
            ...
            var controller = new BorrowerController(httpClientFactory.Object, mockConfiguration.Object);
            //Act
            Borrower borrower = new Borrower();
            //borrower.GetRainmakerBorrower();
            //IActionResult result = await controller.PostAsync(borrower);
            //Assert
