...
final class LoafViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        case .success:
            ...
            imageView.tintColor = UIColor(hexString: "#2ecc71")
            view.backgroundColor = .white
            view.layer.borderWidth = 1
            view.layer.borderColor = UIColor(hexString: "#2ecc71").cgColor
            label.font = Theme.getRubikRegularFont(size: 14)
            label.textColor = Theme.getAppBlackColor()
            constrainWithIconAlignment(.left)
        case .warning:
            imageView.image = Loaf.Icon.warning
            imageView.tintColor = UIColor(hexString: "##f1c40f")
            view.backgroundColor = .white
            view.layer.borderWidth = 1
            view.layer.borderColor = UIColor(hexString: "##f1c40f").cgColor
            label.font = Theme.getRubikRegularFont(size: 14)
            label.textColor = Theme.getAppBlackColor()
            constrainWithIconAlignment(.left)
        case .error:
            imageView.image = Loaf.Icon.error
            imageView.tintColor = UIColor(hexString: "##e74c3c")
            view.backgroundColor = .white
            view.layer.borderWidth = 1
            view.layer.borderColor = UIColor(hexString: "##e74c3c").cgColor
            label.font = Theme.getRubikRegularFont(size: 14)
            label.textColor = Theme.getAppBlackColor()
            constrainWithIconAlignment(.left)
        case .info:
            imageView.image = Loaf.Icon.info
            imageView.tintColor = UIColor(hexString: "##34495e")
            view.backgroundColor = .white
            view.layer.borderWidth = 1
            view.layer.borderColor = UIColor(hexString: "##34495e").cgColor
            label.font = Theme.getRubikRegularFont(size: 14)
            label.textColor = Theme.getAppBlackColor()
            constrainWithIconAlignment(.left)
