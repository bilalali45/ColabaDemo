//
//  UndisclosedMortgageApplicationViewController.swift
//  Colaba
//
...
class UndisclosedMortgageApplicationViewController: BaseViewController {
    ...
    @objc func yesStackViewTapped(){
        ...
        vc.type = .undisclosedMortgageApplication
