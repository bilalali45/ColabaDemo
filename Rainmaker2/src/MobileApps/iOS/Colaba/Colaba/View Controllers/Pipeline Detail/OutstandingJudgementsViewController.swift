...
class OutstandingJudgementsViewController: BaseViewController {
    ...
    func saveQuestion(){
        ...
        self.delegate?.getOutstandingJudgementQuestionModel(question: question)
    }
}

extension OutstandingJudgementsViewController: GovernmentQuestionDetailControllerDelegate{
