...
object AppConstant {
    ...
    const val NOTIFICATION_SETTING: String = "notification"
    ...
    // const val income_source:String = "income_source_type"
    ...
    const val OWNERSHIP_INTEREST: String = "Ownership Interest"
    const val PAY_TYPE_SALARY: String = "Salary"
    const val salary_value: String = "salary_value"
    const val bonus_value: String = "bonus_value"
    const val overtime_value: String = "overtime_value"
    const val commission_value: String = "commission_value"
    const val PAY_TYPE_HOURLY: String = "Hourly"
    const val hourly: String = "hourly_rate"
    const val average_hours: String = "avg_hours"

    const val OWNERSHIP_INTEREST_PERCENTAGE: String = "Ownership Percentage"
