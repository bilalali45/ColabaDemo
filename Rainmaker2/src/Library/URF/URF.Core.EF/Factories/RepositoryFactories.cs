...
namespace URF.Core.EF.Factories
{
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<DbContext, IUnitOfWork<DbContext>, dynamic>> _repositoryFactories;
        ...
        /// </remarks>
        private IDictionary<Type, Func<DbContext, IUnitOfWork<DbContext>, dynamic>> GetFactories()
        {
            return new Dictionary<Type, Func<DbContext, IUnitOfWork<DbContext>, dynamic>>();
        }
        ...
        /// </remarks>
        public Func<DbContext, IUnitOfWork<DbContext>, dynamic> GetRepositoryFactory<T>()
        {
            Func<DbContext, IUnitOfWork<DbContext>, dynamic> factory;
        ...
        /// </remarks>
        public Func<DbContext, IUnitOfWork<DbContext>, dynamic> GetRepositoryFactoryForEntityType<T>() where T : class, ITrackable
        {
        ...
        protected virtual Func<DbContext, IUnitOfWork<DbContext>, dynamic> DefaultEntityRepositoryFactory<T>() where T : class, ITrackable
        {
            return (dbContext, unitOfWork) => new TrackableRepository<DbContext,T>(unitOfWork);
        }
    }
}
