...
namespace LoanApplicationDb.Entity.Models
{
    ...
    public partial class PropertyInfo : URF.Core.EF.Trackable.Entity
    {
        ...
        public bool? HasFirstMortgage { get; set; } // HasFirstMortgage
        public bool? HasSecondMortgage { get; set; } // HasSecondMortgage
        public string MixedUsePropertyExplanation { get; set; } // MixedUsePropertyExplanation (length: 500)
