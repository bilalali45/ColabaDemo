...
namespace LoanApplicationDb.Entity.Models
{
    ...
    public partial class Borrower : URF.Core.EF.Trackable.Entity
    {
        ...
        public bool? WillLiveInSubjectProperty { get; set; } // WillLiveInSubjectProperty
        public int TenantId { get; set; } // TenantId
        public int? SpouseLoanContactId { get; set; } // SpouseLoanContactId
        ...
        /// <summary>
        /// Child IncomeInfoes where [IncomeInfo].[BorrowerId] point to this entity (FK_EmploymentInfo_Borrower)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<IncomeInfo> IncomeInfoes { get; set; } // IncomeInfo.FK_EmploymentInfo_Borrower
        /// <summary>
        ...
        /// </summary>
        public virtual LoanContact LoanContact_LoanContactId { get; set; } // FK_Borrower_LoanContact

        /// <summary>
        /// Parent LoanContact pointed by [Borrower].([SpouseLoanContactId]) (FK_Borrower_SpouseContact)
        /// </summary>
        public virtual LoanContact SpouseLoanContact { get; set; } // FK_Borrower_SpouseContact
