...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class MaritalStatusTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<MaritalStatusType>
    {
        public void Configure(EntityTypeBuilder<MaritalStatusType> builder)
        {
            builder.ToTable("MaritalStatusType", "dbo");
