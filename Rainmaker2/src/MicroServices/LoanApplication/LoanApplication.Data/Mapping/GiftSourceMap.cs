...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class GiftSourceMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<GiftSource>
    {
        public void Configure(EntityTypeBuilder<GiftSource> builder)
        {
            builder.ToTable("GiftSource", "dbo");
            ...
            builder.Property(x => x.IsAccountType).HasColumnName(@"IsAccountType").HasColumnType("bit").IsRequired();
            ...
            builder.Property(x => x.Image).HasColumnName(@"Image").HasColumnType("nvarchar").IsRequired(false).HasMaxLength(50);
            InitializePartial();
        }
