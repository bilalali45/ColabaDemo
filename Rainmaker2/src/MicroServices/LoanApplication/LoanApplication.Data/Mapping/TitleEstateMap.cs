...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class TitleEstateMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<TitleEstate>
    {
        public void Configure(EntityTypeBuilder<TitleEstate> builder)
        {
            builder.ToTable("TitleEstate", "dbo");
