...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class MortgageTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<MortgageType>
    {
        public void Configure(EntityTypeBuilder<MortgageType> builder)
        {
            builder.ToTable("MortgageType", "dbo");
