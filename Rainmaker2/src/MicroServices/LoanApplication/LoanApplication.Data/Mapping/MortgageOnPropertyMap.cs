...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class MortgageOnPropertyMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<MortgageOnProperty>
    {
        public void Configure(EntityTypeBuilder<MortgageOnProperty> builder)
        {
            ...
            builder.Property(x => x.IsHeloc).HasColumnName(@"IsHeloc").HasColumnType("bit").IsRequired(false);
            builder.Property(x => x.MortgageTypeId).HasColumnName(@"MortgageTypeId").HasColumnType("int").IsRequired(false);
            ...
            builder.Property(x => x.CombineWithNewFirstMortgage).HasColumnName(@"CombineWithNewFirstMortgage").HasColumnType("bit").IsRequired(false);
            ...
            builder.HasOne(a => a.MortgageType).WithMany(b => b.MortgageOnProperties).HasForeignKey(c => c.MortgageTypeId).OnDelete(DeleteBehavior.SetNull); // FK_MortgageOnProperty_SecondLienType
