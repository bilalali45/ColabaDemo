...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class ConsentTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<ConsentType>
    {
        public void Configure(EntityTypeBuilder<ConsentType> builder)
        {
            builder.ToTable("ConsentType", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.OwnType).WithMany(b => b.ConsentTypes).HasForeignKey(c => c.OwnTypeId).OnDelete(DeleteBehavior.SetNull); // FK_ConsentType_OwnType_Id
            InitializePartial();
        }
