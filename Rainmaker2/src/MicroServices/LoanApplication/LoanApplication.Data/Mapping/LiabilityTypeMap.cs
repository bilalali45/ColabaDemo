...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class LiabilityTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LiabilityType>
    {
        public void Configure(EntityTypeBuilder<LiabilityType> builder)
        {
            builder.ToTable("LiabilityType", "dbo");
            ...
            builder.Property(x => x.IsObligation).HasColumnName(@"IsObligation").HasColumnType("bit").IsRequired(false);
