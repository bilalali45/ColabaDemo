...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class IncomeGroupMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<IncomeGroup>
    {
        public void Configure(EntityTypeBuilder<IncomeGroup> builder)
        {
            builder.ToTable("IncomeGroup", "dbo");
            ...
            builder.Property(x => x.Image).HasColumnName(@"Image").HasColumnType("varchar(max)").IsRequired(false).IsUnicode(false);
