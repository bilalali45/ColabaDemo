...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class MilitaryStatusListMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<MilitaryStatusList>
    {
        public void Configure(EntityTypeBuilder<MilitaryStatusList> builder)
        {
            builder.ToTable("MilitaryStatusList", "dbo");
