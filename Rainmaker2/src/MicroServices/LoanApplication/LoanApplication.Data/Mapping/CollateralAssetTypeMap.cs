...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class CollateralAssetTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<CollateralAssetType>
    {
        public void Configure(EntityTypeBuilder<CollateralAssetType> builder)
        {
            builder.ToTable("CollateralAssetType", "dbo");
