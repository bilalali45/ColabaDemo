...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class LoanPurposeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LoanPurpose>
    {
        public void Configure(EntityTypeBuilder<LoanPurpose> builder)
        {
            builder.ToTable("LoanPurpose", "dbo");
            ...
            builder.Property(x => x.IsPurchase).HasColumnName(@"IsPurchase").HasColumnType("bit").IsRequired();
