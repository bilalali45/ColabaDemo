...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class FamilyRelationTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<FamilyRelationType>
    {
        public void Configure(EntityTypeBuilder<FamilyRelationType> builder)
        {
            builder.ToTable("FamilyRelationType", "dbo");
