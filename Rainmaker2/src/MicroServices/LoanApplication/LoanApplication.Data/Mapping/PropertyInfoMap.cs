...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class PropertyInfoMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<PropertyInfo>
    {
        public void Configure(EntityTypeBuilder<PropertyInfo> builder)
        {
            ...
            builder.Property(x => x.HasFirstMortgage).HasColumnName(@"HasFirstMortgage").HasColumnType("bit").IsRequired(false);
            builder.Property(x => x.HasSecondMortgage).HasColumnName(@"HasSecondMortgage").HasColumnType("bit").IsRequired(false);
            builder.Property(x => x.MixedUsePropertyExplanation).HasColumnName(@"MixedUsePropertyExplanation").HasColumnType("nvarchar").IsRequired(false).HasMaxLength(500);
