...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class MilitaryAffiliationMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<MilitaryAffiliation>
    {
        public void Configure(EntityTypeBuilder<MilitaryAffiliation> builder)
        {
            builder.ToTable("MilitaryAffiliation", "dbo");
