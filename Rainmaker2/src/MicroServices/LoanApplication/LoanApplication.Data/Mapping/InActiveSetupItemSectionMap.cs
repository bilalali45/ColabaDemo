...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class InActiveSetupItemSectionMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<InActiveSetupItemSection>
    {
        public void Configure(EntityTypeBuilder<InActiveSetupItemSection> builder)
        {
            builder.ToTable("InActiveSetupItemSection", "dbo");
