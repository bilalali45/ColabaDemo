...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class PaidByMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<PaidBy>
    {
        public void Configure(EntityTypeBuilder<PaidBy> builder)
        {
            builder.ToTable("PaidBy", "dbo");
