...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class MilitaryBranchMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<MilitaryBranch>
    {
        public void Configure(EntityTypeBuilder<MilitaryBranch> builder)
        {
            builder.ToTable("MilitaryBranch", "dbo");
