...
namespace LoanApplicationDb.Data.Mapping
{
    ...
    public partial class ResidencyStateMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<ResidencyState>
    {
        public void Configure(EntityTypeBuilder<ResidencyState> builder)
        {
            builder.ToTable("ResidencyState", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.ResidencyType).WithMany(b => b.ResidencyStates).HasForeignKey(c => c.ResidencyTypeId).OnDelete(DeleteBehavior.SetNull); // FK_ResidencyState_ResidencyType
            InitializePartial();
        }
