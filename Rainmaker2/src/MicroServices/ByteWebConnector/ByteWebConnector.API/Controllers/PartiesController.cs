...
namespace ByteWebConnector.API.Controllers
{
    ...
    public class PartiesController : ControllerBase
    {
        ...
        public PartiesController(IHttpClientFactory clientFactory,
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync(ByteParties byteParties)
        {
            var rainmakerParties = byteParties.GetRainmakerParties();

            var content = rainmakerParties.ToJsonString();

            var callResponse =
                await _httpClient.PostAsync(requestUri:
                                           $"{_configuration[key: "RainMaker:Url"]}/api/rainmaker/Parties/AddOrUpdate",
