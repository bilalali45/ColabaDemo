...
namespace ByteWebConnector.API.Controllers
{
    ...
    [ApiController]
    public class BorrowerResidenceController : ControllerBase
    {
        #region Constructors

        public BorrowerResidenceController(IHttpClientFactory clientFactory,
        ...
        {
            var borrowerResidence = byteBorrower.GetBorrowerResidence();

            var content = borrowerResidence.ToJsonString();
