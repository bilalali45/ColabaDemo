namespace ByteWebConnector.API.Models
{
    ...
    public class ByteCustomValue
    {
        ...
        public ByteCustomValue GetCustomValue()
        {
            var byteCustomValue = new ByteCustomValue();
            byteCustomValue.CustomValueId = this.CustomValueId;
            byteCustomValue.CustomValueType = this.CustomValueType;
            byteCustomValue.Name = this.Name;
            byteCustomValue.Value = this.Value;
            byteCustomValue.FileDataId = this.FileDataId;
            return byteCustomValue;
        }
    }
}
