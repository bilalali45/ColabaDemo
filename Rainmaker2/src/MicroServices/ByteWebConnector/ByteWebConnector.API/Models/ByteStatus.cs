...
namespace ByteWebConnector.API.Models
{
    public class ByteStatus
    {
        ...
        public string SchedClosingDate { get; set; }
        ...
        public StatusEntity GetRainmakerStatus()
        {
            var statusEntity = new StatusEntity
                               {
                                   ApplicationDate = Convert.ToDateTime(this.ApplicationDate).Date,
                                   EstimatedClosingDate = Convert.ToDateTime(this.SchedClosingDate).Date,
