...
namespace DocumentManagement.Tests
{
    public class DocumentTest
    {
        ...
        public async Task TestGetDocumemntsByTemplateIdsController()
        {
            ...
            var controller = new DocumentController(mock.Object, null, null, null, null, Mock.Of<ILogger<DocumentController>>(),null,null);
        ...
        public async Task TestGetFilesController()
        {
            ...
            var documentController = new DocumentController(mock.Object, null, null, null, null, Mock.Of<ILogger<DocumentController>>(), null, null);
        ...
        public async Task TestmcuRenameControllerTrue()
        {
            ...
            var documentController = new DocumentController(mock.Object, null, null, mocksettingservice.Object, null, Mock.Of<ILogger<DocumentController>>(), null, null);
            documentController.ControllerContext = context;
        ...
        public async Task TestViewController()
        {
           ...
           // Mock<IFileService> mockFileService = new Mock<IFileService>();
            ...
            // Act  
            DocumentController controller = new DocumentController(mock.Object, mockFileEncryptorFacotry.Object, mockFtpClient.Object, mockSettingService.Object, mockKeyStoreService.Object, Mock.Of<ILogger<DocumentController>>(), null, null);
            controller.ControllerContext = context;
            View view = new View();
        ...
        */
        ...
        public async Task TestDeleteFileControllerTrue()
        {
            ...
            var controller = new DocumentController(mock.Object, null, null, null, null, null, null, null);
