    ...
    public class DocumentTest
    {
        ...
        public async Task TestViewController()
        {
           ...
           // Mock<IFileService> mockFileService = new Mock<IFileService>();
            ...
            mock.Setup(x => x.View(It.IsAny<AdminFileViewModel>(), It.IsAny<int>(), It.IsAny<string>())).ReturnsAsync(fileViewDTO);
            mockSettingService.Setup(x => x.GetSetting()).ReturnsAsync(setting);
        ...
        public async Task TestViewService()
        {
            ...
            //Act
            var dto = await service.View(adminFileViewModel, 1, "127.0.0.1");
            //Assert
            Assert.NotNull(dto);
