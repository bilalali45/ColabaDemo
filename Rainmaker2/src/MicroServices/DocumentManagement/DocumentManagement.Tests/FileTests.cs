...
namespace DocumentManagement.Tests
{
    public class FileTests
    {
        ...
        public async Task TestDoneControllerTrue()
        {
            ...
            var controller = new FileController(mock.Object, null, null, null, null, null, Mock.Of<ILogger<FileController>>(),null);
        ...
        public async Task TestDoneControllerFalse()
        {
            ...
            var fileController = new FileController(mock.Object, null, null, null, null, null, Mock.Of<ILogger<FileController>>(), null);
        ...
        public async Task TestRenameControllerTrue()
        {
            ...
            var controller = new FileController(mock.Object, null, null,  mocksettingservice.Object, null, null, Mock.Of<ILogger<FileController>>(), null);
        ...
        public async Task TestViewController()
        {
            ...
            // Act  
            FileController controller = new FileController(mockfileservice.Object, mockfileencryptorfacotry.Object, mockftpclient.Object, mocksettingservice.Object, mockKeyStoreService.Object, mockconfiguration.Object, Mock.Of<ILogger<FileController>>(), null);
            controller.ControllerContext = context;
        ...
        public async Task TestSubmitController()
        {
            ...
            mockfileservice.Setup(x => x.Submit(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>())).ReturnsAsync(true);
            ...
            FileController controller = new FileController(mockfileservice.Object, mockfileencryptorfacotry.Object, mockftpclient.Object, mocksettingservice.Object, mockKeyStoreService.Object, mockconfiguration.Object, Mock.Of<ILogger<FileController>>(), mockNotificationService.Object);
            controller.ControllerContext = context;
        ...
        public async Task TestSubmitControllerException()
        {
            ...
            mockfileencryptor.Setup(x => x.EncryptFile(It.IsAny<Stream>(), It.IsAny<string>())).Returns(filePath);
            mockftpclient.Setup(x => x.UploadAsync(Path.GetFileName(filePath), filePath)).Verifiable();
            mockfileservice.Setup(x => x.Submit(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>())).ReturnsAsync(false);
