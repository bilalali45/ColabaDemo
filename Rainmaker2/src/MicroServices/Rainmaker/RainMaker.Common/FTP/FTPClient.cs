...
namespace RainMaker.Common.FTP
{
    public class FtpClient
    {
        ...
        public async Task<string> DownloadFileTextAsync(string remoteFile)
        {
            var tempFile = FileHelpers.CreateEmptyTmpFile();
            await DownloadAsync(remoteFile, tempFile);
            var text = await FileHelpers.ReadFileTextAsync(tempFile);
        ...
        //public void Downloadfolder(string remoteFolder,string destinationfolder)
        //{
        ...
        //    }
        //    var directories = this.DirectoryListSimple(remoteFolder);
        //    foreach (var file in files)
        //    {
        //        Downloadfolder(remoteFolder + "/" + file, destinationfolder + "/" + file);
        //    }
           
        //    foreach (var dir in directories)
        //    {
               
        //        Downloadfolder(remoteFolder + "/" + dir, destinationfolder + "/" + dir);
        //    }
