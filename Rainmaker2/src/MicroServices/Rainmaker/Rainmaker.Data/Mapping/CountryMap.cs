...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class CountryMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<Country>
    {
        public void Configure(EntityTypeBuilder<Country> builder)
        {
            ...
            builder.Property(x => x.TwoLetterIsoCode).HasColumnName(@"TwoLetterIsoCode").HasColumnType("nvarchar").IsRequired(false).HasMaxLength(2);
            builder.Property(x => x.ThreeLetterIsoCode).HasColumnName(@"ThreeLetterIsoCode").HasColumnType("nvarchar").IsRequired(false).HasMaxLength(3);
            builder.Property(x => x.NumericIsoCode).HasColumnName(@"NumericIsoCode").HasColumnType("int").IsRequired();
