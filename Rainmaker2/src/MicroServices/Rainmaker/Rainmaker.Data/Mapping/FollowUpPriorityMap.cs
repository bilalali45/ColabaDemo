...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class FollowUpPriorityMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<FollowUpPriority>
    {
        public void Configure(EntityTypeBuilder<FollowUpPriority> builder)
        {
            builder.ToTable("FollowUpPriority", "dbo");
