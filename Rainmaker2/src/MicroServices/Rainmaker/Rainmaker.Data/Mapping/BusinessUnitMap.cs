...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class BusinessUnitMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<BusinessUnit>
    {
        public void Configure(EntityTypeBuilder<BusinessUnit> builder)
        {
            ...
            builder.Property(x => x.DefaultLeadSourceId).HasColumnName(@"DefaultLeadSourceId").HasColumnType("int").IsRequired(false);
            ...
            builder.Property(x => x.WebUrl).HasColumnName(@"WebUrl").HasColumnType("nvarchar").IsRequired(false).HasMaxLength(150);
            ...
            builder.Property(x => x.TpId).HasColumnName(@"TpId").HasColumnType("nvarchar").IsRequired(false).HasMaxLength(500);
            ...
            builder.Property(x => x.Banner).HasColumnName(@"Banner").HasColumnType("varchar").IsRequired(false).IsUnicode(false).HasMaxLength(50);
            ...
            builder.HasOne(a => a.LeadSource).WithMany(b => b.BusinessUnits).HasForeignKey(c => c.DefaultLeadSourceId).OnDelete(DeleteBehavior.SetNull); // FK_BusinessUnit_LeadSource
            InitializePartial();
        }
