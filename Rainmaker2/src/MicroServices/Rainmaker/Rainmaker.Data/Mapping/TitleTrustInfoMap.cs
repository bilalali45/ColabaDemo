...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class TitleTrustInfoMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<TitleTrustInfo>
    {
        public void Configure(EntityTypeBuilder<TitleTrustInfo> builder)
        {
            builder.ToTable("TitleTrustInfo", "dbo");
