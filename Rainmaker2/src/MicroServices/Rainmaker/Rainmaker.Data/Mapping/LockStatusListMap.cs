...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LockStatusListMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LockStatusList>
    {
        public void Configure(EntityTypeBuilder<LockStatusList> builder)
        {
            builder.ToTable("LockStatusList", "dbo");
            ...
            builder.Property(x => x.LockTypeId).HasColumnName(@"LockTypeId").HasColumnType("int").IsRequired();
