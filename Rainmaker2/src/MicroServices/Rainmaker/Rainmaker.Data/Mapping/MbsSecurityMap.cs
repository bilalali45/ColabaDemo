...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class MbsSecurityMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<MbsSecurity>
    {
        public void Configure(EntityTypeBuilder<MbsSecurity> builder)
        {
            builder.ToTable("MbsSecurity", "dbo");
            ...
            builder.Property(x => x.Months).HasColumnName(@"Months").HasColumnType("int").IsRequired(false);
            InitializePartial();
        }
