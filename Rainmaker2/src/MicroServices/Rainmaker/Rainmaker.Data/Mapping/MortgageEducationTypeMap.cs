...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class MortgageEducationTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<MortgageEducationType>
    {
        public void Configure(EntityTypeBuilder<MortgageEducationType> builder)
        {
            builder.ToTable("MortgageEducationType", "dbo");
