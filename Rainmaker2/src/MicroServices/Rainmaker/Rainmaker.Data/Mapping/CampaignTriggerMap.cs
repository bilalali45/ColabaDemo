...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class CampaignTriggerMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<CampaignTrigger>
    {
        public void Configure(EntityTypeBuilder<CampaignTrigger> builder)
        {
            builder.ToTable("CampaignTrigger", "dbo");
