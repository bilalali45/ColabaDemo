...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LeadGroupMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LeadGroup>
    {
        public void Configure(EntityTypeBuilder<LeadGroup> builder)
        {
            builder.ToTable("LeadGroup", "dbo");
