...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class SecondLienTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<SecondLienType>
    {
        public void Configure(EntityTypeBuilder<SecondLienType> builder)
        {
            builder.ToTable("SecondLienType", "dbo");
