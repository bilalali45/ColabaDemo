...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LeadSourceMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LeadSource>
    {
        public void Configure(EntityTypeBuilder<LeadSource> builder)
        {
            builder.ToTable("LeadSource", "dbo");
            ...
            builder.Property(x => x.LogoFileName).HasColumnName(@"LogoFileName").HasColumnType("nvarchar").IsRequired(false).HasMaxLength(250);
