...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class TemplateFormMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<TemplateForm>
    {
        public void Configure(EntityTypeBuilder<TemplateForm> builder)
        {
            builder.ToTable("TemplateForm", "dbo");
            ...
            builder.Property(x => x.ViewOnId).HasColumnName(@"ViewOnId").HasColumnType("int").IsRequired();
            builder.Property(x => x.DocumentTypeId).HasColumnName(@"DocumentTypeId").HasColumnType("int").IsRequired();
