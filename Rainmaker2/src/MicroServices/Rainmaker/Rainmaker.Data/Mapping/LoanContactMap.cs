...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LoanContactMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LoanContact>
    {
        public void Configure(EntityTypeBuilder<LoanContact> builder)
        {
            ...
            // Foreign keys
            builder.HasOne(a => a.Contact).WithMany(b => b.LoanContacts).HasForeignKey(c => c.ContactId).OnDelete(DeleteBehavior.SetNull); // FK_LoanContact_Contact
            builder.HasOne(a => a.DemographicMedium).WithMany(b => b.LoanContacts).HasForeignKey(c => c.DemographicMediumId).OnDelete(DeleteBehavior.SetNull); // FK_LoanContact_DemographicMedium
