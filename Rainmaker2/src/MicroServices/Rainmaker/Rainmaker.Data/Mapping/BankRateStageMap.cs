...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class BankRateStageMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<BankRateStage>
    {
        public void Configure(EntityTypeBuilder<BankRateStage> builder)
        {
            builder.ToTable("BankRateStage", "dbo");
