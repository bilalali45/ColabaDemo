...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class DebtToIncomeRatioMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<DebtToIncomeRatio>
    {
        public void Configure(EntityTypeBuilder<DebtToIncomeRatio> builder)
        {
            builder.ToTable("DebtToIncomeRatio", "dbo");
            ...
            builder.Property(x => x.From).HasColumnName(@"From").HasColumnType("int").IsRequired();
