...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class RegionMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<Region>
    {
        public void Configure(EntityTypeBuilder<Region> builder)
        {
            ...
            builder.Property(x => x.RegionTypeId).HasColumnName(@"RegionTypeId").HasColumnType("int").IsRequired(false);
            builder.Property(x => x.TypeList).HasColumnName(@"TypeList").HasColumnType("nvarchar(max)").IsRequired(false);
            ...
            builder.Property(x => x.ZipCodes).HasColumnName(@"ZipCodes").HasColumnType("nvarchar(max)").IsRequired(false);
            builder.Property(x => x.Cities).HasColumnName(@"Cities").HasColumnType("nvarchar(max)").IsRequired(false);
            builder.Property(x => x.IsDeleted).HasColumnName(@"IsDeleted").HasColumnType("bit").IsRequired();
            builder.Property(x => x.Xml).HasColumnName(@"Xml").HasColumnType("ntext").IsRequired(false);
            InitializePartial();
        }
