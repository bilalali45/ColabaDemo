...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class HolidayTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<HolidayType>
    {
        public void Configure(EntityTypeBuilder<HolidayType> builder)
        {
            builder.ToTable("HolidayType", "dbo");
            ...
            builder.Property(x => x.IsFederal).HasColumnName(@"IsFederal").HasColumnType("bit").IsRequired();
