...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LeadTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LeadType>
    {
        public void Configure(EntityTypeBuilder<LeadType> builder)
        {
            builder.ToTable("LeadType", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.LeadSource).WithMany(b => b.LeadTypes).HasForeignKey(c => c.LeadSourceId).OnDelete(DeleteBehavior.SetNull); // FK_LeadType_LeadSource
            InitializePartial();
        }
