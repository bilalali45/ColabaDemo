...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class SubscriptionSectionMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<SubscriptionSection>
    {
        public void Configure(EntityTypeBuilder<SubscriptionSection> builder)
        {
            builder.ToTable("SubscriptionSection", "dbo");
