...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class AdjustmentMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<Adjustment>
    {
        public void Configure(EntityTypeBuilder<Adjustment> builder)
        {
            ...
            builder.Property(x => x.AdjustmentTypeId).HasColumnName(@"AdjustmentTypeId").HasColumnType("int").IsRequired(false);
            ...
            // Foreign keys
            builder.HasOne(a => a.Formula).WithMany(b => b.Adjustments).HasForeignKey(c => c.FormulaId).OnDelete(DeleteBehavior.SetNull); // FK_Adjustment_Formula
            builder.HasOne(a => a.RangeSet).WithMany(b => b.Adjustments).HasForeignKey(c => c.RangeSetId).OnDelete(DeleteBehavior.SetNull); // FK_Adjustment_RangeSet
            builder.HasOne(a => a.Rule).WithMany(b => b.Adjustments).HasForeignKey(c => c.RuleId).OnDelete(DeleteBehavior.SetNull); // FK_Adjustment_Rule
            InitializePartial();
        }
