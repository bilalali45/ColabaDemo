...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class RangeSetMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<RangeSet>
    {
        public void Configure(EntityTypeBuilder<RangeSet> builder)
        {
            builder.ToTable("RangeSet", "dbo");
