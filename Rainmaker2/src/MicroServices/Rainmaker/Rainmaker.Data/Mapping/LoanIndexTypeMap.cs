...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LoanIndexTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LoanIndexType>
    {
        public void Configure(EntityTypeBuilder<LoanIndexType> builder)
        {
            builder.ToTable("LoanIndexType", "dbo");
            ...
            builder.Property(x => x.IndexValue).HasColumnName(@"IndexValue").HasColumnType("decimal(18,3)").IsRequired(false);
