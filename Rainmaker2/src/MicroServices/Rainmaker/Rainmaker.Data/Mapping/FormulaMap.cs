...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class FormulaMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<Formula>
    {
        public void Configure(EntityTypeBuilder<Formula> builder)
        {
            builder.ToTable("Formula", "dbo");
            ...
            builder.Property(x => x.Expression).HasColumnName(@"Expression").HasColumnType("nvarchar").IsRequired().HasMaxLength(500);
            builder.Property(x => x.DependOnIds).HasColumnName(@"DependOnIds").HasColumnType("nvarchar(max)").IsRequired(false);
