  ...
  describe("Other Income Screen", () => {
    ...
    <Store.Provider value={{ state, dispatch }}>
       <OtherIncome/>
        ...
        await waitFor(() => {
          expect(getByTestId("otherIncome-row")).toBeInTheDocument();
          expect(getByTestId("otherIncome-row").children[0]).toHaveTextContent('Select Your Income Type:')
          let otherGroup = getAllByTestId("other-grp");
          expect(otherGroup).toHaveLength(6);

          let list = getAllByTestId("other-list");
