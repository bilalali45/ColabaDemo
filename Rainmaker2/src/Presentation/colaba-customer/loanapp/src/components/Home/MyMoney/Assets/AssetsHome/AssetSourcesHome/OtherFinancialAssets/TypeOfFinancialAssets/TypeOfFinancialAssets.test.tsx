...
import {TypeOfFinancialAssets} from './TypeOfFinancialAssets';
...
beforeEach(() => {
  ...
  describe("Other Financial Asset List", () => {
    test("Other Financial Asset List", async () => {
      const { getByTestId , getAllByTestId} = render(
          <Store.Provider value={{ state, dispatch }}>
          <TypeOfFinancialAssets />
          </Store.Provider>
      );
      
      await waitFor(() => {   
         expect(getByTestId('subtitle')).toHaveTextContent('What type of financial asset is this?')   
