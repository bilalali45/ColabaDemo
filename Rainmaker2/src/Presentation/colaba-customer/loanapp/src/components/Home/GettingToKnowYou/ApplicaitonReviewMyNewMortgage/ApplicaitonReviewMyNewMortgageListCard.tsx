...
import { ReviewSingleApplicantIcon, ReviewCoApplicantIcon, EditIcon } from '../../../../Shared/Components/SVGs';
...
export const ApplicaitonReviewMyNewMortgageCard: React.FC<{
        ...
        <>
            <div className="review-item">
                ...
                <div className="r-content">
                    <div className="title">
                        <h4>{loanApplicationReviewer.firstName} {loanApplicationReviewer.lastName}</h4>
                    </div>
