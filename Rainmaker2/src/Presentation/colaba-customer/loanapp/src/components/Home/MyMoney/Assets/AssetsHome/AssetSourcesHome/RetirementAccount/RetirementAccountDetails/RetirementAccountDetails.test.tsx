...
import {RetirementAccountDetails} from './RetirementAccountDetails';
...
beforeEach(() => {
  ...
  describe("Retirement Account Detail", () => {
    test("Should render Retirement Account Detail", async () => {
      ...
      await waitFor(() => {      
        expect(getByTestId('retirement-form')).toBeInTheDocument();
        ...
        await waitFor(() => { 
          ...
          fireEvent.change(instituteInput, { target: { value: "Retirement Bank Ltd" } });
          fireEvent.change(accountInput, { target: { value: "123789456000" } });
          fireEvent.change(balanceInput, { target: { value: "870000" } });
        });

        await waitFor(() => {
          expect(instituteInput).toHaveDisplayValue("Retirement Bank Ltd");
          expect(accountInput).toHaveDisplayValue("123789456000");
        ...
        let addAnother = getByTestId('AddAnotherRetirementAccountBtn');
