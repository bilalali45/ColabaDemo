...
import { ReviewSingleApplicantIcon, EditIcon } from '../../../../Shared/Components/SVGs';
        ...
        <>
            <div className="review-item">
                <div className="r-icon">
                    {(loanApplicationReviewer.ownTypeId == 1 ? <ReviewSingleApplicantIcon /> : <ReviewSingleApplicantIcon />)}
                </div>
                <div className="r-content">
                    ...
                    <div className="otherinfo">
                        {StringServices.addressGenerator(loanApplicationReviewer?.borrowerAddress)}
                    </div>
