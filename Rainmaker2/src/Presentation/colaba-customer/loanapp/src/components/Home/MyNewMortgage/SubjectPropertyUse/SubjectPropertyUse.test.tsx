...
import {SubjectPropertyUse} from './SubjectPropertyUse';
...
const state = {
  ...
  describe("Subject Property Screen", () => {
    test("Should render Subject List", async () => {
        ...
        await waitFor(() => {                       
            expect(getByTestId('subjectPropertUsage-form')).toBeInTheDocument();
