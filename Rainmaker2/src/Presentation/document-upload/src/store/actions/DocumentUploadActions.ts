...
export class DocumentUploadActions {
    ...
    static async submitDocuments(currentSelected: DocumentRequest, file: Document, dispatchProgress: Function, loanApplicationId: string, tenentId: string) {
    ...
    static removeActualFile(fileName: string, prevFiles: Document[], dispatch: Function) {
        prevFiles.filter(f => {
