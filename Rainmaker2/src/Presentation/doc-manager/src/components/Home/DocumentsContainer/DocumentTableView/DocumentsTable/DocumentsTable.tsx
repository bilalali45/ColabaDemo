...
export const DocumentsTable = () => {
  ...
  const [droppedOnDoc, setDroppedOnDoc] = useState();
  const [wasFileDropped, setWasFileDropped] = useState<boolean>(false);
  const [filesDroppedFromPC, setFilesDroppedFromPC] = useState<any>(null);
  ...
  useEffect(() => {
    ...
    setDroppedOnDoc(null);
    setFilesDroppedFromPC(null);
            ...
            documentItems?.map((d: any, i: number) => {
              return (
                <DocumentItem key={i}
                  ...
                  retryFile={retryFile}
                  setDroppedOnDoc={setDroppedOnDoc}
                  setWasFileDropped={setWasFileDropped}
                  setFilesDroppedFromPC={setFilesDroppedFromPC}
                />
              )
            }) : noDocFound()
          // :
        ...
        <div className="dm-dt-foot" >
          ...
          {(addFileDialog || wasFileDropped) &&
            <AddFileToDoc
              ...
              setWasFileDropped={setWasFileDropped}
              wasFileDropped={wasFileDropped}
              droppedFiles={filesDroppedFromPC}
              droppedOnDocument={ droppedOnDoc }
               />
          }
        </div>
      }
