...
describe('Loan Status Update : Header', ()=>{
    ...
    test('Loan Status Update Header : Heading', async () => {
        ...
        const { getByText } = render(<StoreProvider><LoanStatusUpdateHeader {...props}/></StoreProvider>);
        // debug();  
    ...
    test('Loan Status Update Header : Info Component', async () => {
        const { getByTestId, debug } = render(<StoreProvider><LoanStatusUpdateHeader {...props}/></StoreProvider>);
        //debug(); 
        // 
