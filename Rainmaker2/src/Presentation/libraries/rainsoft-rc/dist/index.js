...
var RainsoftRcHeader = function RainsoftRcHeader(_ref) {
  ...
  }, "Hello,", displayName), React__default.createElement(HeaderMenu, {
    options: options
  })))))));
};
...
var DocumentView = function DocumentView(_ref) {
  ...
  }, React__default.createElement(SVGdownload, null)))), React__default.createElement("li", null, React__default.createElement("button", {
    className: "document-view--button",
