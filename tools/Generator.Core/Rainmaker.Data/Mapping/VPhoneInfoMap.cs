...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class VPhoneInfoMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<VPhoneInfo>
    {
        public void Configure(EntityTypeBuilder<VPhoneInfo> builder)
        {
            builder.ToTable("vPhoneInfo", "dbo");
