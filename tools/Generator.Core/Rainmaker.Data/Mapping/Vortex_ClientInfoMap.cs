...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class Vortex_ClientInfoMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<Vortex_ClientInfo>
    {
        public void Configure(EntityTypeBuilder<Vortex_ClientInfo> builder)
        {
            ...
            builder.Property(x => x.NetworkInterfaces).HasColumnName(@"NetworkInterfaces").HasColumnType("nvarchar").IsRequired(false).HasMaxLength(150);
            ...
            builder.Property(x => x.CpUs).HasColumnName(@"CPUs").HasColumnType("varchar").IsRequired(false).IsUnicode(false).HasMaxLength(50);
            ...
            builder.Property(x => x.UserInfo).HasColumnName(@"UserInfo").HasColumnType("varchar").IsRequired(false).IsUnicode(false).HasMaxLength(50);
