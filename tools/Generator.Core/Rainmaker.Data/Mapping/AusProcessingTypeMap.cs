...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class AusProcessingTypeMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<AusProcessingType>
    {
        public void Configure(EntityTypeBuilder<AusProcessingType> builder)
        {
            builder.ToTable("AusProcessingType", "dbo");
