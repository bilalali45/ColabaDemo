...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class SetupTableMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<SetupTable>
    {
        public void Configure(EntityTypeBuilder<SetupTable> builder)
        {
            builder.ToTable("SetupTable", "dbo");
            ...
            // Foreign keys
            builder.HasOne(a => a.EntityType).WithMany(b => b.SetupTables).HasForeignKey(c => c.EntityTypeId).OnDelete(DeleteBehavior.SetNull); // FK_SetupTable_EntityType
            InitializePartial();
        }
