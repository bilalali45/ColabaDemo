...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class PmiCompanyMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<PmiCompany>
    {
        public void Configure(EntityTypeBuilder<PmiCompany> builder)
        {
            builder.ToTable("PmiCompany", "dbo");
