...
namespace RainMaker.Data.Mapping
{
    ...
    public partial class LoanToValueMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<LoanToValue>
    {
        public void Configure(EntityTypeBuilder<LoanToValue> builder)
        {
            builder.ToTable("LoanToValue", "dbo");
            ...
            builder.Property(x => x.From).HasColumnName(@"From").HasColumnType("decimal(18,2)").IsRequired(false);
            builder.Property(x => x.To).HasColumnName(@"To").HasColumnType("decimal(18,2)").IsRequired(false);
            InitializePartial();
        }
